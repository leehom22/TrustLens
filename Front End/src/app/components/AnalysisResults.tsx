import { AlertTriangle, CheckCircle, Info, FileText, Globe, Wand2, Shield } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <Tabs defaultValue="metadata" className="space-y-4">
        <TabsList className="bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-700">
        ...
        <TabsContent value="content" className="space-y-4">
          ...
          <div className="bg-red-50 dark:bg-red-950/50 rounded-xl border border-red-400 dark:border-red-600/50 shadow-lg p-6">
