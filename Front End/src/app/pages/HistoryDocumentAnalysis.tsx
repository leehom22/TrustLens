                                                ...
                                                <div className="relative mt-4">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex gap-3 justify-end">
                                                            <button disabled={isLoading} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-2">
                                                                {isLoading && <Loader2 className="w-4 h-4 animate-spin" />}
                                                                {isLoading ? 'Submitting...' : 'Submit'}
                                                            </button>
                                                            {!isLoading && (
                                                                <button type="button" className="bg-gray-100 dark:bg-slate-700 px-4 py-2 rounded-lg" onClick={() => setOpenFeedback(prev => ({ ...prev, metadata: false }))}>
                                                                    Cancel
                                                                </button>
                                                            )}
                                                        </div>
